...
class LoginController extends Controller
{
    ...
    */
    ...
    if ($user) {
        // 2. This manually logs the user in without a password
    ...
    // 4. If this message appears, your 'user_type' in DB isn't 'admin'
    //     $rules = [
    ...
    //         if (Auth::user()->status ==0 &&  Auth::user()->user_type=='admin') {
