	...
	<div class="page-header">
		<div class="card breadcrumb-card">
			<div class="row justify-content-between align-content-between" style="height: 100%;">
				<div class="col-md-6">
					<h3 class="page-title">Verified Users</h3>
					<ul class="breadcrumb">
                    ...
                    <table class="table table-hover table-center mb-0" id="table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $value['bio'] ? $value['bio'] : '--'}}</td>
                                    <td>{{ $value['dob'] ? $value['dob'] : '--'}}</td>
                                    <td> <?php if($value['image']!=='')
                                                    {
                                                        ?>
                                                     <img src="{{asset($value['image'])}}" class="w-100" alt="No IMG" onerror="this.onerror=null;this.src='{{ asset('assets/admin/img/default-user.png') }}';">
                                                   <?php
                                                    }else
                                                    {?>
                                    ...
                                    <!-- <td><button class="btn btn-primary"><?php echo $value['is_verifyId']==1 ? 'Verifyed' : 'Verify' ?></button></td> -->
                                        ...
                                        <td><a href="{{route('user_info',$value['id'])}}"><i class="fa fa-eye"></i></i></a></td>
                                </tr>
                                @endforeach
                        </tbody>
                    </table>
