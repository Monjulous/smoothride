                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                <tr>
                                    <td align="center" valign="top" style="padding: 20px;">
                                        ...
                                        <span class="company-name">Smooth Ride</span>
                                    </td>
                                </tr>
                            </table>
                            <!-- Content -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                ...
                                <td align="left" valign="top" style="padding: 20px;">
                                    <h1>Document verification</h1>
                                     <h3>Dear {{@$user['adminame']}}</h3>
                                    <p>{{@$user['name']}} uploaded document kindly check and  Approve it.</p>
                                    <a href="{{ url('user_info/'.@$user['id']) }}">Smooth Ride Admin Approval</a>
